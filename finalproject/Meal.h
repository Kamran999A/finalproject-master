...
public:
	Kitchen() {
		...
		MainDish m2("Toboli", "Main dish", 9.0, 7, 5);
		MainDish m3("Biryani", "Main dish", 9.1, 12, 5);
		...
		FastFood f4("Kurdish Tawa Burger", "Fast Food", 9.2, 9, 5);
		Dessert d1("Cheesecake", "Dessert", 8.8, 3, 5);
		Dessert d2("Croissant", "Dessert", 7.8, 2, 5);
		Dessert d3("Kurdish Special Baklava", "Dessert", 9.3, 1.5, 5);
