...
public:
	...
	virtual void show() {
		std::cout << "=====================================" << endl;
		std::cout << "ID : " << this->myID << endl;
		std::cout << "Name : " << getName() << endl;
		std::cout << "Count : " << getCount() << endl;
		std::cout << "Fat : " << getFat() << endl;
		std::cout << "Protein : " << getProtein() << endl;
		std::cout << "Carbohydrates : " << getCarbohydrates() << endl;
		std::cout << "Kcal : " << getKcal() << endl;
		std::cout << "Price : " << getPrice() << endl;
	}
...
public:
	...
	void show()override {
		Ingredient::show();
		std::cout << "Calcium : " << getCalcium() << endl;
	}
};
...
public:
	...
	void show()override {
		Ingredient::show();
		std::cout << "Magnesium : " << getMagnesium() << endl;
	}
};
...
public:
	...
	void show()override {
		Ingredient::show();
		std::cout << "is spicy : " << getIsSpicy() << endl;
	}
};
...
public:
	...
	void show()override {
		Ingredient::show();
		std::cout << "Cholesterol : " << getCholesterol() << endl;
	}
};
...
public:
	...
	void show()override {
		Ingredient::show();
		std::cout << "Starch : " << getStarch() << endl;
	}
};
class byName {
	string order;
...
class Stock {
	...
	//vector<Notification> ingredientss;
public:
	Stock() {
	...
	void deleteIngredientByID(int ID) {
		...
		for (auto item : ingredients) {
			...
			{
				std::cout << "Enter ID correctly !" << endl;
			}
		}
	...
	void deleteIngredientByName(string name) {
		...
		for (auto item : ingredients) {
			...
			{
				std::cout << "Enter name correctly !" << endl;
			}
		}
		ingredients.remove(ingredient);
		writeDataToFileIngredient();
	...
	//	//ingredientss.push_back(Notification("Ingredient deleted"));
	//}
	void addIngredientToOrder(int ID) {
		...
		std::cout << ingredient.getName() << endl;
		finalPrice += ingredient.getPrice();
		std::cout << "Sum of ingridients : " << finalPrice;
		decreaseCount(ID);
	}
